...
module FIR_Fliter (
   ...
   CLKINVX16M CLK__L2_I0 (.Y(CLK__L2_N0), 
	.A(CLK__L1_N0));
   CLKINVX40M CLK__L1_I0 (.Y(CLK__L1_N0), 
	.A(CLK));
   CLKINVX32M m_clk__L4_I5 (.Y(m_clk__L4_N5), 
	.A(m_clk__L3_N1));
   CLKINVX32M m_clk__L4_I4 (.Y(m_clk__L4_N4), 
	.A(m_clk__L3_N1));
   CLKINVX32M m_clk__L4_I3 (.Y(m_clk__L4_N3), 
	.A(m_clk__L3_N1));
   CLKINVX32M m_clk__L4_I2 (.Y(m_clk__L4_N2), 
	.A(m_clk__L3_N0));
   CLKINVX32M m_clk__L4_I1 (.Y(m_clk__L4_N1), 
	.A(m_clk__L3_N0));
   CLKINVX32M m_clk__L4_I0 (.Y(m_clk__L4_N0), 
	.A(m_clk__L3_N0));
   CLKINVX40M m_clk__L3_I1 (.Y(m_clk__L3_N1), 
	.A(m_clk__L2_N0));
   CLKINVX40M m_clk__L3_I0 (.Y(m_clk__L3_N0), 
	.A(m_clk__L2_N0));
   CLKINVX40M m_clk__L2_I0 (.Y(m_clk__L2_N0), 
	.A(m_clk__L1_N0));
   INVX14M m_clk__L1_I0 (.Y(m_clk__L1_N0), 
	.A(m_clk));
   TIELOM LTIE_LTIELO (.Y(LTIE_LTIELO_NET));
   ...
   CLKINVX12M U703 (.Y(Fliter_Signal[15]), 
	.A(n542));
   mux2X1_1 mux_clk (.IN_0(CLK__L2_N0), 
	.IN_1(scan_clk), 
	.SEL(test_mode), 
	.OUT(m_clk));
